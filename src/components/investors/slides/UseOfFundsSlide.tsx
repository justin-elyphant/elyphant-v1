...
const useOfFunds = [
  {
    category: 'Paid Marketing & Ad Spend',
    amount: '$1.4M',
    percentage: 40,
    icon: Megaphone,
    purpose: 'Performance ads, influencer, brand — primary growth lever',
  },
  {
    ...
    percentage: 14,
    icon: Users,
    purpose: '2 FTE creative + growth ($240K/yr loaded × 2 yrs)',
  },
  {
    category: 'Sales Manager (Vendor Acquisition)',
    amount: '$300K',
    percentage: 9,
    icon: Briefcase,
    purpose: 'E-commerce sales lead — onboards Shopify vendors ($120K base + load × 2 yrs)',
  },
  {
    category: 'Head of Product (Founder)',
    amount: '$250K',
    percentage: 7,
    icon: Users,
    purpose: '$125K/yr × 2 — below-market to extend runway',
  },
  {
    category: 'Offshore Full-Stack Engineer',
    amount: '$140K',
    percentage: 4,
    icon: Code,
    purpose: 'Migrate off Lovable, own platform stack ($70K/yr × 2)',
  },
  {
    ...
    percentage: 6,
    icon: Server,
    purpose: 'Supabase, Stripe, Zinc, OpenAI/Lovable AI Gateway, monitoring',
  },
  {
