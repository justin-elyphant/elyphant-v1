            ...
            >
              <div className="group relative">
                <UnifiedProductCard
                  ...
                  onShare={onShare}
                />
                <div className="absolute inset-0 rounded-lg bg-gradient-to-t from-background/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none" />
              </div>
            </div>
          ))}
        </div>
