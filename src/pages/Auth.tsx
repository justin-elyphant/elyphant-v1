      ...
      <AnimatePresence>
        ...
        >
          ...
          <motion.div
            ...
            className="relative z-10 w-[calc(100%-2rem)] max-w-md max-h-[90vh] overflow-y-auto bg-background rounded-3xl shadow-2xl border border-border/50 md:my-8 overscroll-contain"
