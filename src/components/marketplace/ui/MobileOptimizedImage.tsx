...
const MobileOptimizedImage: React.FC<MobileOptimizedImageProps> = ({
  ...
  return (
    <div className={cn("relative overflow-hidden bg-muted", getAspectRatioClass(), className)}>
        ...
        <div className="absolute inset-0 animate-pulse">
          ...
          {isMobile && (
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-6 h-6 border-2 border-border border-t-gray-600 rounded-full animate-spin" />
            </div>
          )}
        </div>
      )}
