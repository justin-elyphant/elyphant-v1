...
BEGIN
  ...
  VALUES (p_user_id, p_first_name, p_last_name, p_first_name || ' ' || p_last_name, p_username, p_email, p_dob, p_birth_year, p_interests, p_gift_preferences, p_data_sharing_settings, p_shipping_address, p_profile_image, p_user_type::user_type, true, now())
