-- Update the can_view_profile function to properly handle accepted connections
-- Replace the existing function instead of dropping it to avoid dependency issues
...
BEGIN
  ...
  -- CRITICAL FIX: Always allow viewing for accepted connections
