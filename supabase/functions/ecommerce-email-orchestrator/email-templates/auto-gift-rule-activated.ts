...
export const autoGiftRuleActivatedTemplate = (props: AutoGiftRuleActivatedProps): string => {
  ...
  const content = `
    <div style="text-align: center; margin-bottom: 32px;">
      ...
      <p style="margin: 0; color: #6B7280; font-size: 16px;">
        ${recipient_first_name} completed their profile
      </p>
    </div>

    <div style="background-color: #D1FAE5; background: linear-gradient(135deg, #D1FAE5 0%, #A7F3D0 100%); border-radius: 12px; padding: 24px; margin-bottom: 24px;">
      <h2 style="margin: 0 0 16px 0; color: #065F46; font-size: 18px; font-weight: 600;">
        🎉 Great News!
      </h2>
      
      <p style="margin: 0; color: #047857; font-size: 14px; line-height: 1.6;">
        ${recipient_first_name} has completed their profile and added their shipping address. 
    ...
    <div style="background: #EFF6FF; border-left: 4px solid #3B82F6; border-radius: 8px; padding: 16px; margin-bottom: 24px;">
      <p style="margin: 0; color: #1E40AF; font-size: 14px; line-height: 1.6;">
        ...
        When the occasion arrives, our AI will select the perfect gift based on ${recipient_first_name}'s preferences 
  ...
  return baseEmailTemplate({
    content,
    preheader: `Auto-gift rule for ${recipient_first_name} is now active!`,
