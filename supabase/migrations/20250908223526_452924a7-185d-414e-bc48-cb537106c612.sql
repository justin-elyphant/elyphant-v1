-- Enhanced delete_user_account function with comprehensive cleanup
...
BEGIN
  ...
  -- Comprehensive deletion with proper ordering to handle foreign keys
  
  -- Delete from all tables that reference the user (in dependency order)
  
  -- 1. Delete wishlist items first (references wishlists)
