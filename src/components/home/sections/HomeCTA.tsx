...
const HomeCTA = () => {
  ...
  return (
    <>
      ...
      <div className="bg-gradient-to-br from-purple-600 to-purple-800 text-white rounded-xl p-8 mb-12 shadow-lg">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-4">Find the Perfect Gift for Everyone</h2>
          <p className="text-lg text-white/80 mb-6 max-w-2xl mx-auto">
            Whether it's a birthday, anniversary, or just because - we've got you covered. 
            Discover personalized gift recommendations tailored to each unique person in your life.
          </p>
          ...
          <div className="flex justify-center space-x-4">
            <Button 
              asChild 
              size="lg" 
              className="bg-white text-purple-700 hover:bg-white/90 transition-colors"
            >
              <Link to="/gifting">
                <Gift className="mr-2 h-5 w-5" />
                Start Gifting
