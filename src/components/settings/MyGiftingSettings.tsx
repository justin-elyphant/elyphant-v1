...
const MyGiftingSettings: React.FC = () => {
  const {
    form,
    isSaving,
    loading,
    ...
    return (
      <div className="flex items-center justify-center p-8">
        <div className="text-center space-y-4">
          ...
          <p className="text-muted-foreground">Loading your gifting preferences...</p>
        </div>
      </div>
    );
  }
...
export default MyGiftingSettings;
