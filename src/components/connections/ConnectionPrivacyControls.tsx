    ...
    <div className="space-y-4">
      {hasAnyBlocks && (
        <div className="flex items-center gap-2 p-3 bg-warning/10 text-warning rounded-lg">
          ...
          <span className="text-sm">Recurring gifts are disabled due to blocked data</span>
        </div>
      )}
      ...
      <div className="space-y-4">
        ...
        <p className="text-sm text-muted-foreground">
          ...
          Blocking data will prevent them from accessing this information for recurring gifts.
        </p>
