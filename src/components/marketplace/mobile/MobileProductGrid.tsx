      ...
      {Array.from({ length: 6 }).map((_, index) => (
        <Card key={index} className="animate-pulse">
          <CardContent className="p-0">
            <div className="aspect-square bg-muted rounded-t-lg mb-3"></div>
    ...
    return (
      <div className="flex flex-col items-center justify-center py-12 px-4 safe-area-inset">
        <div className="text-center max-w-sm">
          ...
          <p className="text-muted-foreground mb-4 leading-relaxed">Try adjusting your search or filters to find what you're looking for.</p>
          {onRefresh && (
            <Button 
              onClick={() => {
        ...
        <CardContent className="p-0">
          ...
          <div className="relative aspect-square overflow-hidden rounded-t-lg bg-muted">
            ...
            <Button
              variant="ghost"
              size="sm"
              className="absolute top-2 right-2 w-8 h-8 p-0 bg-white/80 hover:bg-background touch-target-44"
          ...
          <div className="p-3 space-y-2 flex-1 flex flex-col">
            ...
            <Button
              variant="outline"
              size="sm"
              className="w-full h-9 text-sm font-medium border-border hover:border-border active:scale-[0.96] transition-transform duration-100"
