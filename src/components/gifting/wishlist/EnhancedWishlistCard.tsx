...
import { Heart, ShoppingCart, Trash2, Gift, ExternalLink } from "lucide-react";
  ...
  return (
    <>
      <Card className="group relative overflow-hidden hover:shadow-lg transition-all duration-200 border-border/50 hover:border-primary/20">
        ...
        {(item as any).product_source === 'zinc_api' && (
        ...
        <CardContent className="p-0">
          {/* Image */}
          <div className="aspect-square bg-muted overflow-hidden cursor-pointer" onClick={() => setShowDetails(true)}>
            <img 
