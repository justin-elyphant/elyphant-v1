-- Fixed Email Templates System for Trunkline Communications
...
-- Insert template variables for each template (fixed query)
INSERT INTO email_template_variables (template_id, variable_name, variable_type, is_required, description) 
SELECT et.id, vars.variable_name, vars.variable_type, vars.is_required, vars.var_description
FROM email_templates et, (VALUES
...
) AS vars(template_type, variable_name, variable_type, is_required, var_description)
WHERE et.template_type = vars.template_type;