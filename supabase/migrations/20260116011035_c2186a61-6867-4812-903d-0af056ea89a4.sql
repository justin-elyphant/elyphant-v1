-- Fix invitation URL in queue_connection_request_email function
-- Changes:
-- 1. Use invitation_token instead of id in the URL
-- 2. Use correct production domain (elyphant.ai instead of app.elyphant.ai)
    ...
    BEGIN
      ...
      INSERT INTO email_queue (
        ...
        jsonb_build_object(
          ...
          -- FIXED: Use invitation_token and correct domain
          'invitation_url', 'https://elyphant.ai/auth?invite=' || COALESCE(NEW.invitation_token, NEW.id::text)
        )
      );
