    ...
    <div className="border-t border-white/10 p-4 bg-gradient-to-r from-white/10 to-white/5 backdrop-blur-sm rounded-b-3xl">
      <div className="flex gap-3">
        <Input
          ...
          disabled={disabled}
          className="flex-1 bg-white/40 border-white/30 backdrop-blur-sm text-foreground placeholder:text-muted-foreground rounded-full px-4 py-2 focus:bg-white/50 transition-all duration-200"
        />
        <Button
          onClick={handleSend}
