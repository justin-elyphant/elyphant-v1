...
const RecurringGiftUpsellBanner: React.FC<RecurringGiftUpsellBannerProps> = ({
  holidayLabel,
  recipientName,
  visible,
  onConvert,
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-muted-foreground mt-0.5">
                  Automate {recipientName}'s gift for next year?
                </p>
              </div>
...
export default RecurringGiftUpsellBanner;
