...
SET 
  ...
  updated_at = NOW()
WHERE zinc_request_id = 'c0fcd8f9e5f37fe8b3eb6a3a636efb50';
...
SELECT 
  id,
  'Order set to retry_pending due to ZMA overload. First retry scheduled for ' || (NOW() + INTERVAL '1 hour')::text,
  'system_update',
  true
FROM orders 
WHERE zinc_request_id = 'c0fcd8f9e5f37fe8b3eb6a3a636efb50';