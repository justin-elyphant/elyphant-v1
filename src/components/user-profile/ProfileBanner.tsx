  ...
  return (
    <div className="relative h-64 bg-gradient-to-r from-purple-500 via-pink-500 to-indigo-500">
      ...
      <div className="relative flex items-end justify-between p-6 h-full">
        <div className="flex items-end space-x-4">
          ...
          <div className="text-white space-y-2 pb-4">
            ...
            {userData?.username && (
              <p className="text-lg opacity-90">@{userData.username}</p>
            )}
            
            {/* Bio */}
            {userData?.bio && (
              <p className="text-base opacity-90 max-w-md">{userData.bio}</p>
            )}
      ...
      <div className="absolute bottom-0 left-0 right-0 bg-white/95 backdrop-blur-sm">
        <div className="flex justify-center space-x-8 py-4 px-6">
          ...
          <div className="text-center">
            ...
            <div className="text-sm text-gray-600">Wishlists</div>
          </div>
        </div>
      </div>
    </div>
