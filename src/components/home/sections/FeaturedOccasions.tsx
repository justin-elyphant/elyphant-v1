              ...
              {occasions.map((occasion) => {
                ...
                return (
                  <CarouselItem key={occasion.id} className="pl-2 md:pl-4 basis-1/2 sm:basis-1/3 md:basis-1/4 lg:basis-1/4 xl:basis-1/5">
                    <div
                      className="group relative p-4 md:p-6 bg-background rounded-xl shadow-md hover:shadow-xl transition-all duration-300 cursor-pointer border border-border h-full"
                    ...
                    >
                      ...
                      <Button
                        variant="ghost"
                        size="sm"
                        className="w-full group-hover:bg-muted/50 text-xs md:text-sm"
                      >
                        Shop Now
